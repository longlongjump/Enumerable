...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Eugene Ovchynnykov"
  # s.authors            = { "Eugene Ovchynnykov" => "nerohellier@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Eugene Ovchynnykov"
  ...
  s.source       = { :git => "git@github.com:longlongjump/Enumerable.git", :tag => "0.0.1" }
